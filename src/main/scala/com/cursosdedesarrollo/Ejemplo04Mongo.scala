...
import org.mongodb.scala.{BulkWriteResult, Document, MongoClient, MongoCollection, MongoDatabase, Observable, Observer, SingleObservable, Subscription}
//filtros como equal
...
object Ejemplo04Mongo{
  ...
  def main(args: Array[String]): Unit = {
    ...
    val insertObservable: Observable[InsertOneResult] = collection2.insertOne(document)
    ...
    collection2.insertOne(doc).subscribe(new Observer[InsertOneResult] {
